  ...
  return (
    <>
      <button
        ...
        className="rounded-full border border-[#F4C430] text-[#F4C430] px-5 py-2.5 text-sm font-semibold hover:bg-[#F4C430]/10 transition-colors"
      >
        ✨ Générer avec IA
      </button>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm p-4">
          <div className="w-full max-w-lg rounded-2xl bg-card border border-border p-6 shadow-xl">
            <div className="flex items-center justify-between mb-6">
              <h2 className="text-lg font-bold text-foreground">Générer un article avec IA</h2>
