    ...
    const tourSteps: TourStep[] = useMemo(() => [
        {
            ...
            description: 'G̩rez ici toutes les demandes d\'intervention de vos locataires et suivez l\'avancement des travaux.',
        ...
        },
        {
            ...
            description: 'D̩clarez un nouvel incident (plomberie, ̩lectricit̩, etc.) en quelques clics pour vos biens ou au nom d\'un locataire.',
        ...
        },
        {
            ...
            description: 'Retrouvez la liste des interventions en cours. Suivez les statuts : Recherche artisan, En attente de validation, ou Termin̩.',
