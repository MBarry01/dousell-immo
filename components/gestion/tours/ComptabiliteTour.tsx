...
export function ComptabiliteTour() {
    ...
    const tourSteps: TourStep[] = useMemo(() => [
        {
            ...
            description: 'Sélectionnez l\'année fiscale et téléchargez un rapport PDF complet ou exportez vos données pour votre comptable.',
        ...
        },
        {
            ...
            description: 'Suivez en temps réel les loyers encaissés, en attente et les retards de paiement (avec taux de recouvrement).',
        ...
        },
        {
            ...
            description: 'Visualisez l\'évolution mensuelle de vos revenus et la répartition des paiements via des graphiques interactifs.',
        ...
        },
        {
            ...
            title: 'Détails & Dépenses',
            description: 'Naviguez entre les onglets pour gérer vos dépenses déductibles et analyser la rentabilité nette bien par bien.',
    ...
    const floatingButton = mounted ? createPortal(
        <button
            ...
            aria-label="Relancer le tutoriel comptabilité"
        >
