...
export function EquipeTour() {
    const { showTour, closeTour, resetTour } = useOnboardingTour('dousell_equipe_tour', 1000);
    ...
    const tourSteps: TourStep[] = useMemo(() => [
        ...
        {
            targetId: 'tour-team-invite',
            title: 'Inviter un collaborateur',
            description: 'Ajoutez facilement un nouveau membre (Gestionnaire, Agent, Comptable) et envoyez-lui une invitation par email.',
            imageSrc: 'https://images.unsplash.com/photo-1516321318423-f06f85e504b3?auto=format&fit=crop&q=80&w=600',
            imageAlt: 'InviterMembre'
        },
        {
    ...
    return (
        <>
            <OnboardingTour
                ...
                storageKey="dousell_equipe_tour"
                isDark={isDark}
            />
