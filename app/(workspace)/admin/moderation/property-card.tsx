...
export function PropertyModerationCard({
  ...
  return (
    <motion.div
      ...
      className="group overflow-hidden rounded-2xl border border-border bg-card transition-all hover:border-primary/20 hover:bg-muted/10 shadow-sm"
    >
      <div className="grid gap-4 p-6 md:grid-cols-[180px_1fr_auto] lg:grid-cols-[200px_1fr_auto]">
          ...
          <div className="flex flex-wrap gap-2 pt-2">
            ...
            {property.proof_document_url && (
              <Button
                variant="ghost"
                size="sm"
                className="h-8 rounded-full text-xs text-blue-600 dark:text-blue-400 hover:bg-blue-500/10"
        ...
        <div className="flex flex-col gap-2 min-w-[140px]">
          <Button
            ...
            className="w-full rounded-full bg-emerald-600 text-white hover:bg-emerald-700 disabled:opacity-50"
          >
            {isApproving ? (
              <>
          ...
          <Button
            ...
            disabled={isApproving || isRejecting}
            variant="secondary"
            className="w-full rounded-full border border-red-200 bg-red-50 text-red-600 hover:bg-red-100 hover:text-red-700 dark:border-red-500/20 dark:bg-transparent dark:text-red-300 dark:hover:bg-red-500/10 disabled:opacity-50"
          >
            {isRejecting ? (
              <>
                <Loader2 className="mr-2 h-4 w-4 animate-spin" />
