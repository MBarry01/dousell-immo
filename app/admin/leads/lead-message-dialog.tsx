    ...
    <Dialog open={open} onOpenChange={setOpen}>
      <DialogTrigger asChild>
        ...
        >
          ...
          <Eye className="h-3.5 w-3.5 text-white/40 group-hover:text-amber-500 transition-colors flex-shrink-0 mt-0.5" />
        </Button>
      </DialogTrigger>
      <DialogContent className="max-w-2xl bg-[#0b0f18] border-white/10">
        <DialogHeader>
