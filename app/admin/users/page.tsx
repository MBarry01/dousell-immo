  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div>
          <h1 className="text-3xl font-semibold text-white">Gestion des Utilisateurs</h1>
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-5">
        ...
        <Card className="border-white/10 bg-white/5">
          ...
          <CardContent>
            <div className="text-2xl font-bold text-white">{stats.moderateurs}</div>
          </CardContent>
        </Card>
        ...
        <Card className="border-white/10 bg-white/5">
          ...
          <CardContent>
            <div className="text-2xl font-bold text-white">{stats.sansRole}</div>
          </CardContent>
        </Card>
      </div>
                    ...
                    >
                      ...
                      <td className="px-4 py-4">
                        <div className="flex items-center gap-2">
                          ...
                          <span className="text-white/80 truncate max-w-[250px]">
                            {user.email || "N/A"}
                          </span>
                        </div>
                      </td>
