    ...
    return (
        <main className="bg-black min-h-screen">
            ...
            <div className="container mx-auto px-6 pt-32 pb-20">
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            {stats.map((stat, i) => (
                                <motion.div
                                    ...
                                    className="rounded-2xl border border-white/10 bg-white/5 p-6 text-center backdrop-blur-sm hover:bg-white/10 transition-colors"
                                >
                    ...
                    <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
                        {features.map((feature, index) => (
                            <motion.div
                                ...
                                className="group rounded-2xl border border-white/10 bg-zinc-900/50 p-6 transition-all hover:border-[#F4C430]/30 hover:shadow-lg hover:shadow-[#F4C430]/5 hover:-translate-y-1"
                            >
                                ...
                                <h3 className="mb-2 text-lg font-bold text-white group-hover:text-[#F4C430] transition-colors">
                                    {feature.title}
                                </h3>
                        ...
                        <div className="relative">
                            ...
                            <div className="relative rounded-2xl border border-white/10 bg-zinc-900 p-6 shadow-2xl">
                                <div className="mb-4 flex items-center justify-between">
                                    ...
                                    <span className="rounded-full bg-emerald-500/20 px-3 py-1 text-xs text-emerald-400 border border-emerald-500/20">En ligne</span>
                                </div>
                                <div className="space-y-3">
                                    <div className="flex items-center justify-between rounded-xl bg-white/5 p-4 border border-white/5">
                                        ...
                                        <span className="text-sm font-bold text-[#F4C430]">85% collecté</span>
                                    </div>
                                    <div className="flex items-center justify-between rounded-xl bg-white/5 p-4 border border-white/5">
                                        <div className="flex items-center gap-3">
                                    ...
                                    <div className="flex items-center justify-between rounded-xl bg-white/5 p-4 border border-white/5">
                                        ...
                                        <span className="rounded-full bg-[#F4C430] px-2 py-0.5 text-xs font-bold text-black">3 nouveaux</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                >
                    <div className="absolute top-0 left-0 w-64 h-64 bg-[#F4C430]/5 rounded-full blur-3xl -translate-y-1/2 -translate-x-1/2" />
                    ...
                    <div className="relative z-10 flex flex-col items-center">
                        <div className="mb-6 h-20 w-20 rounded-full bg-[#F4C430]/10 flex items-center justify-center border border-[#F4C430]/20">
                            <Shield className="h-10 w-10 text-[#F4C430]" />
                        </div>
