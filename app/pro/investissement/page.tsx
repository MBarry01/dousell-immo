        ...
        <main className="bg-black min-h-screen">
            ...
            <div className="container mx-auto px-6 pt-32 pb-20">
                ...
                <motion.section
                    ...
                    className="relative overflow-hidden rounded-[36px] border border-white/10 bg-gradient-to-br from-zinc-900 to-black p-8 text-white shadow-2xl sm:p-12 lg:p-16 mb-20"
                >
                    ...
                    <div className="relative z-10 max-w-3xl">
                        ...
                        <h1 className="mt-6 text-4xl font-bold leading-tight sm:text-5xl lg:text-6xl font-display">
                            Investissez dans l&apos;immobilier{" "}
                            <span className="bg-gradient-to-r from-[#F4C430] to-[#FFD700] bg-clip-text text-transparent">
                                sénégalais
                            </span>
                        </h1>
                        <p className="mt-6 max-w-xl text-lg text-white/70 font-light">
                        ...
                        <div className="mt-8 flex flex-wrap gap-4">
                            <Link
                                href="#projets"
                                className="inline-flex items-center gap-2 rounded-full bg-[#F4C430] px-6 py-3 font-semibold text-black transition-all hover:bg-[#E5B82A] hover:scale-105 shadow-lg shadow-[#F4C430]/20"
                            >
                                Voir les projets
                        ...
                        {projets.map((projet, index) => (
                            ...
                            >
                                ...
                                <div className="relative h-48 overflow-hidden">
                                    ...
                                    {/* Status badge */}
                                    <span className={`absolute left-4 top-4 rounded-full px-3 py-1 text-xs font-bold uppercase tracking-wide ${projet.status === "Nouveau"
                                    ...
                                    {/* Rendement */}
                                    <div className="absolute bottom-4 right-4 rounded-xl bg-[#F4C430] px-3 py-1.5 text-center shadow-lg">
                                        <div className="text-lg font-bold text-black">{projet.rendement}</div>
                                        <div className="text-[10px] text-black/70 font-semibold uppercase">Rendement</div>
                                    </div>
                                </div>

                                {/* Content */}
                                <div className="p-6">
                                    <div className="mb-2 flex items-center gap-2 text-xs text-white/50 uppercase tracking-wide font-medium">
                                    ...
                                    <h3 className="mb-1 text-xl font-bold text-white group-hover:text-[#F4C430] transition-colors">
                                        {projet.title}
                                    </h3>

                                    <p className="mb-4 text-sm font-bold text-[#F4C430]">{projet.prix}</p>

                                    <ul className="mb-6 space-y-2">
                                        {projet.features.map((feature) => (
                                            <li key={feature} className="flex items-center gap-2 text-xs text-white/60">
                                                <CheckCircle className="h-3.5 w-3.5 text-[#F4C430]" />
                                                {feature}
                                            </li>
                                        ))}
                                    </ul>
                                    ...
                                    <a
                                        ...
                                        className="flex w-full items-center justify-center gap-2 rounded-xl bg-white/5 py-3 text-sm font-bold text-white transition-all hover:bg-[#F4C430] hover:text-black hover:shadow-lg hover:shadow-[#F4C430]/10"
                                    >
                                        En savoir plus
                                        <ArrowRight className="h-4 w-4" />
                                    </a>
                ...
                <motion.section
                    ...
                    viewport={{ once: true }}
                    transition={{ duration: 0.6 }}
                    className="rounded-[36px] border border-white/10 bg-gradient-to-br from-[#F4C430]/5 via-zinc-900 to-black p-8 sm:p-12 mb-20"
                >
                    <div className="text-center">
                        <h2 className="text-3xl font-bold text-white sm:text-4xl font-display">
                        ...
                        {etapes.map((etape, index) => (
                            ...
                            >
                                ...
                                <div className="relative text-center">
                                    <div className="mx-auto mb-6 flex h-16 w-16 items-center justify-center rounded-full bg-[#F4C430]/10 text-2xl font-bold text-[#F4C430] border border-[#F4C430]/20 shadow-[0_0_15px_rgba(244,196,48,0.2)]">
                                        {etape.step}
                                    </div>
                                    <h3 className="mb-2 font-bold text-white">{etape.title}</h3>
                                    <p className="text-sm text-white/60 leading-relaxed">{etape.description}</p>
                                </div>
                            </motion.div>
                        ))}
                    </div>
                ...
                <motion.section
                    ...
                    viewport={{ once: true }}
                    transition={{ duration: 0.6 }}
                    className="rounded-[36px] border border-[#F4C430]/20 bg-gradient-to-r from-[#F4C430]/10 via-zinc-900 to-zinc-900 p-8 text-center sm:p-12 relative overflow-hidden"
                >
                    ...
                    <div className="relative z-10 flex flex-col items-center">
                        <div className="mb-6 h-20 w-20 rounded-full bg-[#F4C430]/10 flex items-center justify-center border border-[#F4C430]/20">
                            <Calculator className="h-10 w-10 text-[#F4C430]" />
                        </div>

                        <h2 className="mt-2 text-3xl font-bold text-white sm:text-4xl font-display">
                        ...
                        <div className="mt-8 flex flex-wrap justify-center gap-4">
                            <a
                                ...
                                className="inline-flex items-center gap-2 rounded-full bg-[#F4C430] px-8 py-4 font-bold text-black transition-all hover:bg-[#E5B82A] hover:scale-105 shadow-lg shadow-[#F4C430]/20"
                            >
                        ...
                        <p className="mt-6 text-sm text-white/40 uppercase tracking-wide">
