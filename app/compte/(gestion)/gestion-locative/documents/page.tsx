...
import { uploadDocument, deleteDocument, getMyDocuments, getRentalDocuments } from "@/app/compte/mes-documents/actions";
    ...
    return (
        <div className="min-h-screen bg-slate-950 p-6 md:p-8">
            <div className="max-w-7xl mx-auto space-y-8">
                ...
                <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                    ...
                    <Dialog open={uploadDialogOpen} onOpenChange={setUploadDialogOpen}>
                        <DialogTrigger asChild>
                            <Button className="bg-brand hover:bg-brand/90 text-black gap-2">
                        ...
                        <DialogContent className="bg-slate-900 border-slate-800 text-white">
                            ...
                            <div className="space-y-4 py-4">
                                ...
                                <Button
                                    ...
                                    disabled={uploading}
                                    className="w-full bg-brand hover:bg-brand/90 mt-2 text-black"
                                >
                ...
                {/* Content */}
                {loading ? (
                    <div className="text-center py-12 text-slate-500">Chargement de vos documents...</div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                        {filteredDocuments.map((doc) => (
                            <motion.div
                                ...
                                className="group relative bg-slate-900 border border-slate-800 hover:border-brand/30 rounded-xl p-4 transition-all hover:shadow-lg hover:shadow-brand/5"
                            >
                                <div className="flex items-start justify-between mb-3">
                                    ...
                                    <div className="flex gap-1 opacity-0 group-hover:opacity-100 transition-opacity">
                                        <a
                                            ...
                                            className="p-1.5 hover:bg-slate-800 rounded-md text-slate-400 hover:text-blue-400"
                                            title="Prévisualiser"
                                        >
                                            <Eye size={18} />
                                        </a>
                                        ...
                                        <button
                                            ...
                                            className="p-1.5 hover:bg-red-900/20 rounded-md text-slate-400 hover:text-red-400"
                                            title="Supprimer"
                                        >
                                            <Trash size={18} />
                                        </button>
                                ...
                                <div className="space-y-1">
                                    <h3 className="font-medium text-slate-200 truncate" title={doc.name}>
                                        {doc.name}
                                    </h3>
