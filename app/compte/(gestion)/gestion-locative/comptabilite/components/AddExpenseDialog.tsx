                ...
                <form onSubmit={handleSubmit} className="space-y-4 pt-2">
                    ...
                    <div className="space-y-2">
                        ...
                        <input
                            ...
                            required
                            min="1"
                            className="w-full bg-slate-800 border border-slate-700 rounded-md px-3 py-2 text-sm text-slate-100 focus:ring-2 focus:ring-red-500 outline-none"
                        />
                    </div>
                    ...
                    <div className="space-y-2">
                        ...
                        <textarea
                            ...
                            rows={2}
                            className="w-full bg-slate-800 border border-slate-700 rounded-md px-3 py-2 text-sm text-slate-100 focus:ring-2 focus:ring-red-500 outline-none resize-none"
                        />
                    </div>
