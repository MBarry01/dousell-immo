                ...
                <DialogHeader>
                    ...
                    <DialogDescription asChild>
                        <div className="mt-2 space-y-1 text-sm text-slate-400">
                            <span className="block"><strong className="text-white">Locataire:</strong> {alert.tenant_name}</span>
                            <span className="block"><strong className="text-white">Bien:</strong> {alert.property_address}</span>
                            <span className="block"><strong className="text-white">Loyer actuel:</strong> {new Intl.NumberFormat('fr-FR').format(alert.monthly_amount)} FCFA</span>
                            <span className="block"><strong className="text-white">Échéance:</strong> {new Date(alert.end_date).toLocaleDateString('fr-FR')}</span>
                        </div>
                    </DialogDescription>
                </DialogHeader>
