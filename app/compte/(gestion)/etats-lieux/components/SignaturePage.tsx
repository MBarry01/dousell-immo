    ...
    return (
        <div className="space-y-6 pb-8">
            ...
            <div className="flex items-center gap-4">
                <Link href={`/compte/etats-lieux/${reportId}`} className="text-white/60 hover:text-white transition-colors">
            ...
            {isAlreadySigned ? (
                <div className="bg-emerald-500/10 border border-emerald-500/30 rounded-xl p-6 text-center">
                    ...
                    <h3 className="text-lg font-medium text-white mb-2">Document signé</h3>
