...
export function PDFPreview({ reportId }: PDFPageProps) {
    ...
    return (
        <div className="min-h-screen bg-slate-950 p-6 print:p-0 print:bg-white">
            <style jsx global>{`
                @media print {
                    body * {
                        visibility: hidden;
            ...
            <div className="max-w-4xl mx-auto mb-6 flex justify-between items-center print:hidden">
                <Link href="/compte/etats-lieux" className="text-slate-400 hover:text-white flex items-center gap-2">
