        ...
        return (
            <div className="space-y-8 py-6">
                <div className="flex items-center gap-4">
                    <Skeleton className="h-14 w-14 rounded-full border border-zinc-800" />
                ...
                <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                    <Skeleton className="h-48 w-full rounded-xl border border-zinc-800" />
                    <Skeleton className="h-48 w-full rounded-xl border border-zinc-800" />
                </div>
            </div>
        );
            ...
            <FadeIn>
                ...
                <div className="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-3">
                    ...
                    {isTenant && (
                        ...
                        >
                            <Link href="/portal">
                                <Card className="h-full cursor-pointer bg-gradient-to-br from-primary/10 to-zinc-900 border-none transition-all hover:from-primary/20">
                    ...
                    {!isOwner && !gestionLocativeEnabled && (
                        ...
                        >
                            <Link href="/compte/activer-gestion">
                                <Card className={`h-full cursor-pointer border-none transition-all ${gestionLocativeStatus === 'pending'
                                        ? 'bg-gradient-to-br from-amber-500/5 to-zinc-900'
                                        : 'bg-gradient-to-br from-amber-500/10 to-zinc-900 hover:from-amber-500/20'
                                    }`}>
                                    <CardHeader className="p-6">
                                        <div className="flex items-center gap-3 mb-4">
