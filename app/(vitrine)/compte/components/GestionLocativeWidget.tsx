    ...
    return (
        <div className="group relative overflow-hidden rounded-xl border border-slate-800 bg-slate-900/50 hover:bg-slate-900 transition-all duration-300 mb-8">
            ...
            <div className="grid grid-cols-3 divide-x divide-slate-800/50">
                ...
                {/* KPI 1 : Baux Actifs */}
                <Link href="/gestion-locative" className="p-2 flex flex-col items-center justify-center text-center gap-2 hover:bg-slate-800/30 transition-colors cursor-pointer">
            ...
            <Link href="/gestion-locative" className="block border-t border-slate-800 bg-slate-900/30 p-4 hover:bg-slate-800/50 transition-colors">
