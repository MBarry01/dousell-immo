    ...
    <div className="space-y-12 py-10">
      ...
      >
        ...
        <div className="relative z-10">
          ...
          <div className="mt-8 flex flex-wrap gap-4">
            <a
              href="#offres"
              className="inline-flex items-center gap-2 rounded-full bg-[#F4C430] px-6 py-3 font-semibold text-black transition-all hover:bg-[#E5B82A]"
            >
              Voir les offres
            ...
            >
              <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                <div className="flex items-start gap-4">
                  <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-xl bg-[#F4C430]/10">
                    <offre.icon className="h-6 w-6 text-[#F4C430]" />
                  </div>
                  <div>
                    <h3 className="font-semibold text-white group-hover:text-[#F4C430] transition-colors">
                      {offre.title}
                    </h3>
                ...
                <div className="flex flex-col items-start gap-2 sm:items-end sm:text-right">
                  ...
                  <a
                    ...
                    className="mt-2 inline-flex items-center gap-1 rounded-full bg-[#F4C430] px-4 py-2 text-sm font-semibold text-black transition-all hover:bg-[#E5B82A]"
                  >
                    Postuler
      ...
      >
        ...
        <a
          ...
          className="mt-6 inline-flex items-center gap-2 rounded-full bg-[#F4C430] px-8 py-4 font-semibold text-black transition-all hover:bg-[#E5B82A]"
        >
          Candidature spontanée
          <ArrowRight className="h-4 w-4" />
        </a>
