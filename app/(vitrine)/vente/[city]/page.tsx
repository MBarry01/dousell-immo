...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
    ...
    return {
        title: `Immobilier à vendre à ${displayCity} : Toutes les annonces`,
        description: `Trouvez votre bien immobilier à acheter à ${displayCity}. Appartements, villas et terrains à vendre avec Doussel Immo.`,
    };
}
