...
export const metadata: Metadata = {
    title: "Achat Immobilier Sénégal - Toutes les villes",
    description: "Découvrez toutes les villes où Doussel Immo propose des biens à vendre. Appartements, villas et terrains au Sénégal.",
};
    ...
    return (
        <div className="min-h-screen bg-background pb-20">
            <div className="bg-muted/30 border-b">
                <div className="container mx-auto px-4 py-10">
                    ...
                    <p className="text-muted-foreground text-lg max-w-2xl">
                        Sélectionnez une ville pour voir nos offres de vente.
                    </p>
                </div>
            </div>
            ...
            <div className="container mx-auto px-4 py-12">
                {cities.length > 0 ? (
                    /* GRILLE DE CARTES POSTALES (Flex centered) pour Vente */
                    <div className="flex flex-wrap justify-center gap-6">
                        {cities.map((city) => {
                            const imageUrl = getCityImage(city.name);

                            return (
                                <Link
                                    key={city.slug}
                                    href={`/vente/${city.slug}`}
